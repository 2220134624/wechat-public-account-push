...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: ''wx323a4faa8f9ef4b1'',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: ''cd3e24b00939aea26d28b6a7caf53dc0'',
  ...
  USERS: [
    {
      ...
      id: ''o5sis51DcfOCuOIZVWnxWj4xYsgk'',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: ''HHCkj0xE9e7eOCQFWzlq5lOYpvCDCF_SNJRrHxE6Dtw'',
      // 所在省份
      province: '辽宁',
      // 所在城市
      city: '本溪',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2003', date: '02-11',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2021', date: '10-09',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '你的乖乖', year: '2003', date: '03-15',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2021', date: '0-01',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-10-09' },
